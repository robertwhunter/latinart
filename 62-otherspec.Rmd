...
[**HOPE**](https://www.ncbi.nlm.nih.gov/pubmed/10639539) (2000): ![](Logo_RCT.png){height=1.2em} ![](Logo_SEM.png){height=1.2em} - ramipril *vs.* placebo in high-risk patients with vascular disease or diabetes (but not known HFrEF).  Rampril reduced risk of death, MI and stroke.  

```

```{block2, type='box_landmark'}
[**CONSENSUS**](https://www.ncbi.nlm.nih.gov/pubmed/2883575) (1987): ![](Logo_RCT.png){height=1.2em} ![](Logo_SEM.png){height=1.2em} - enalapril *vs.* placebo in NYHA class IV CCF.  Mortality benefit seen in enalapril group.  
